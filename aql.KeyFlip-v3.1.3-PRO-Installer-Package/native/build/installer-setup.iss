...
[Run]
Filename: "{app}\{#MyAppExeName}"; \
    Description: "Launch aql.KeyFlip now"; \
...
begin
  ShellExec(
    'open',
    'mailto:info@ahmedaql.online?subject=aql.KeyFlip%20Feedback',
    '',
    '',
    SW_SHOWNORMAL,
    ewNoWait,
...
begin
  ...
  AddHeroImage(
    IntroPage,
    ExpandConstant('{#InstallerAssets}\01-welcome.png')
  );
  ...
  AddHeroImage(
    HowPage,
    ExpandConstant('{#InstallerAssets}\02-how-it-works.png')
  );
  ...
  AddHeroImage(
    FeaturesPage,
    ExpandConstant('{#InstallerAssets}\03-features.png')
  );
  ...
  AddHeroImage(
    DeveloperPage,
    ExpandConstant('{#InstallerAssets}\04-developer.png')
  );
